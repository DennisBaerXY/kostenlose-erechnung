<script>
    ...
    $: taxAmount = Object.values(taxGroups).reduce((sum, group) => sum + group.tax, 0);
    ...
    <div class="invoice-paper">
      ...
      <div class="invoice-header">
        <div class="sender-info">
          ...
          <div class="address-line">{data.sender.zip || 'PLZ'} {data.sender.city || 'Stadt'}</div>
        ...
        <div class="invoice-title">
          <h1>Rechnung</h1>
          <div class="invoice-number">Nr. {data.metadata.invoiceNumber || '2025-001'}</div>
        </div>
      </div>
      ...
      <div class="recipient-section">
        ...
        <div class="recipient-info">
          ...
          <div>{data.recipient.zip || 'PLZ'} {data.recipient.city || 'Stadt'}</div>
        </div>
      </div>
      ...
      <div class="invoice-meta">
        ...
        {#if data.metadata.deliveryDate}
          <div class="meta-item">
            ...
            <span class="meta-value">{formatDate(data.metadata.deliveryDate)}</span>
          </div>
        {/if}
        ...
        <tbody>
          {#each data.items as item, index}
            <tr>
              ...
              <td class="description">{item.description || 'Position ' + (index + 1)}</td>
