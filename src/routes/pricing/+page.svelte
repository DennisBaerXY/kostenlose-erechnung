...
<script>
	...
	async function handleSubscribe(planId) {
		...
		try {
			...
			alert(
				"Fehler beim Erstellen des Abonnements. Bitte versuchen Sie es erneut."
			);
		} finally {
			loading = false;
		}
...
<svelte:head>
	...
	<meta
		name="description"
		content="Upgraden Sie auf Premium für unbegrenzte E-Rechnungen, Cloud-Speicherung und Vorlagen. Ab 4,99€/Monat."
	/>
</svelte:head>
	...
	<div class="pricing-grid">
		...
		<div class="pricing-card">
			...
			<div class="plan-features">
				<ul>
					<li>5 E-Rechnungen pro Monat</li>
					<li>XRechnung & ZUGFeRD</li>
					<li>PDF & XML Export</li>
		...
		<div class="pricing-card featured">
			...
			<div class="plan-features">
				<ul>
					<li>Alle Funktionen des kostenlosen Plans</li>
					<li>
						<strong>Unbegrenzte</strong> E-Rechnungen
					</li>
					<li>Cloud-Speicherung (verschlüsselt)</li>
					<li>Rechnungsvorlagen</li>
					<li>Kundenverwaltung mit Autofill</li>

					<li>DSGVO-konformer Datenexport</li>
				</ul>
			</div>
		...
		<div class="pricing-card">
			...
			<div class="plan-action">
				<a
					href="mailto:enterprise@kostenlose-erechnung.de"
	...
	<div class="faq-section">
		...
		<div class="faq-grid">
			<div class="faq-item">
				...
				<p>
					Ja! Sie können Premium 7 Tage lang kostenlos und unverbindlich testen.
			...
			<div class="faq-item">
				...
				<p>
					Wir akzeptieren alle gängigen Zahlungsmethoden über Mollie:
					Kreditkarte, SEPA-Lastschrift, PayPal und Sofortüberweisung.
				</p>
			</div>
			...
			<div class="faq-item">
				...
				<p>
					Ja, Sie können Ihr Abonnement jederzeit zum Ende der Laufzeit
					kündigen. Bei Jahreszahlungen erfolgt keine anteilige Rückerstattung.
				</p>
			</div>
			...
			<div class="faq-item">
				...
				<p>
					Absolut! Alle Daten werden verschlüsselt in deutschen Rechenzentren
					gespeichert. Wir sind vollständig DSGVO-konform.
				</p>
			</div>
			...
			<div class="faq-item">
				...
				<p>
					Sie können alle Ihre Daten jederzeit exportieren. Nach der Kündigung
					bleiben Ihre Daten 30 Tage verfügbar, danach werden sie sicher
					gelöscht.
				</p>
			</div>
			...
			<div class="faq-item">
				...
				<p>
					Ja, Premium-Nutzer erhalten Zugang zu unserer vollständigen REST API
					mit ausführlicher Dokumentation und Code-Beispielen.
				</p>
			</div>
		</div>
	</div>
