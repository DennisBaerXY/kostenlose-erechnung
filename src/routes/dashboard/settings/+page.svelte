...
<script>
	...
	// Form validation
	$: isFormValidFirmData =
		formData.name && formData.street && formData.zip && formData.city;
	...
	$: isFormValidTaxData =
		formData.taxId || formData.ustId || formData.companyInfo.managingDirector;
	...
	async function handleSave() {
		if (!isFormValidFirmData || !isFormValidBankData || !isFormValidTaxData) {
